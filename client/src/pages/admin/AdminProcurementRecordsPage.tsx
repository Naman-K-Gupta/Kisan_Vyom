  ...
  return (
    <div className="space-y-6 animate-fade-in print:p-0 print:space-y-3">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <button
            ...
            disabled={isLoading}
            className="px-3 py-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold transition flex items-center gap-1.5 shadow-sm active:scale-95"
          >
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white text-xs font-bold transition flex items-center gap-1.5 shadow-sm shadow-emerald-600/20"
          >
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full pl-9 pr-8 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs font-semibold text-slate-800 outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition appearance-none cursor-pointer"
              >
                <option value="ALL">🏛️ All Centres (Statewide Total)</option>
                {centres.map((c) => (
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="text-[10px] px-1.5 py-0.5 rounded font-bold text-slate-500 hover:bg-slate-100 transition"
                >
                  Yesterday
                </button>
              </div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-xs font-semibold text-slate-800 outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition cursor-pointer"
              />
        ...
        <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-xl border border-slate-200 bg-slate-50 text-xs outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
            />
          </div>
      ...
      {summary.cropBreakdown.length > 0 && (
        <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-sm flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {summary.cropBreakdown.map((cb) => (
              <span
                key={cb.cropId}
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-slate-100 text-slate-800 text-xs font-bold"
              >
              ...
              <tbody className="divide-y divide-slate-100 font-medium">
                {filteredRecords.map((record) => (
                  <tr key={record.id} className="hover:bg-slate-50/80 transition">
                    ...
                    {/* Quality & Grade */}
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] bg-emerald-50 text-emerald-800 font-bold border border-emerald-200">
                    ...
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      <div className="flex items-center gap-1">
                        {record.status === 'PAID' ? (
                          ...
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] bg-amber-100 text-amber-800 font-bold">
                            <Clock className="w-3 h-3 text-amber-600" /> Bank Transit
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] bg-slate-100 text-slate-700 font-bold">
                            Pending
                          </span>
                        )}
                      </div>
