      ...
      <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        {waitingTokens.length > 0 && (
          <button
            ...
            className="px-4 py-2 rounded-none bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-md shadow-emerald-600/20 active:scale-95 transition-all flex items-center gap-1.5 self-start sm:self-auto"
          >
                ...
                <tr key={t.id} className="hover:bg-slate-50/70 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <div className="w-10 h-10 rounded-none bg-slate-100 border border-slate-300 overflow-hidden flex items-center justify-center font-bold text-slate-700 text-sm group-hover:border-emerald-500 transition-all shadow-sm">
                        ...
                        <span className="absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-none bg-emerald-600 text-white flex items-center justify-center text-[8px] group-hover:scale-110 transition-transform">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-none bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-sm transition-all flex items-center gap-1"
                      >
                        <Play className="w-3 h-3" /> Call
                      </button>
                      <button
                        onClick={() => onSkipToken(t.id)}
                        className="p-1.5 rounded-none border border-slate-200 hover:bg-slate-100 text-slate-500 transition-colors"
