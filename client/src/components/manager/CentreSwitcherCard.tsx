...
export const CentreSwitcherCard: React.FC<CentreSwitcherCardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-900 via-slate-900 to-slate-950 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden border border-emerald-800/40">
      <div className="absolute top-0 right-0 w-80 h-80 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />

      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5">
        <div className="space-y-2">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="px-2.5 py-1 rounded-lg bg-emerald-500/20 border border-emerald-400/30 text-[11px] font-bold tracking-wider uppercase text-emerald-300 flex items-center gap-1.5">
              <Building2 className="w-3.5 h-3.5 text-emerald-400" />
              {t('manager.activeCentreBadge')}
            </span>

            {centre && (
              <span className="px-2.5 py-1 rounded-lg bg-white/10 text-[11px] font-semibold text-slate-200 flex items-center gap-1">
        ...
        <div className="flex items-center gap-3 self-start md:self-auto">
          <button
            ...
            className="px-5 py-3 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold text-xs shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2 active:scale-95"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/10 border border-white/15 text-white placeholder-slate-400 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-400"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3.5 py-2.5 rounded-xl bg-slate-800 border border-white/15 text-white text-xs focus:outline-none focus:ring-2 focus:ring-emerald-400"
              >
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {isSelected && (
                        <span className="p-0.5 rounded-full bg-emerald-400 text-slate-950 flex-shrink-0">
